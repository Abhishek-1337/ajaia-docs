  ...
  return (
    <div className="editor-toolbar">
      <div className="toolbar-group">
        <button
          className={`toolbar-btn toolbar-btn-text ${isActive("paragraph")}`}
        ...
        <button
          className={`toolbar-btn toolbar-btn-text ${isActive("heading", { level: 1 })}`}
        ...
        <button
          className={`toolbar-btn toolbar-btn-text ${isActive("heading", { level: 2 })}`}
        ...
        <button
          className={`toolbar-btn toolbar-btn-text ${isActive("heading", { level: 3 })}`}
      ...
      <div className="toolbar-group">
        ...
        >
          <svg viewBox="0 0 24 24"><path d="M12 17c3.31 0 6-2.69 6-6V3h-2.5v7.5c0 1.93-1.57 3.5-3.5 3.5S8.5 12.43 8.5 10.5V3H6v8c0 3.31 2.69 6 6 6zm-7 2v2h14v-2H5z"/></svg>
        </button>
      </div>
      ...
      <div className="toolbar-group">
        ...
        >
          <svg viewBox="0 0 24 24"><path d="M18.4 10.6C16.55 9 14.15 8 11.5 8c-4.65 0-8.58 3.03-9.96 7.22l2.37.78c1.05-3.19 4.06-5.5 7.59-5.5 1.96 0 3.73.72 5.12 1.88L13 16h9V7l-3.6 3.6z"/></svg>
        </button>
      </div>
    </div>
  );
